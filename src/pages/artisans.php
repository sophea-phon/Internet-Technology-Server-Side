...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Meet the local artisans of Cambodia and discover their traditional crafts"
    />
    ...
    <main>
      ...
      <section class="artisans-hero">
        <div class="container">
          ...
          <p>
            Discover the traditional crafts and skilled artisans of Cambodia
          </p>
        </div>
      </section>
          ...
          <div class="artisan-cards">
            <div class="artisan-card">
              <div class="artisan-img">
                <img
                  src="../../assets/images/silk-weaver.jpg"
                  alt="Silk Weaver"
                />
              </div>
            ...
            <div class="artisan-card">
              <div class="artisan-img">
                <img
                  src="../../assets/images/stone-carver.jpg"
                  alt="Stone Carver"
                />
              </div>
              <div class="artisan-info">
