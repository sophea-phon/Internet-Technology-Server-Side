...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Detailed information about Cambodia's ancient temples"
    />
      ...
      <div class="header-container">
        ...
        <nav class="navbar">
          <ul class="nav-menu">
            ...
            <li class="nav-item">
              <a href="temples.html" class="nav-link active">Temples</a>
            </li>
            <li class="nav-item">
              <a href="artisans.html" class="nav-link">Local Artisans</a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
          <div class="temple-details-content">
            ...
            <div class="temple-details-image">
              <img
                src="../../assets/images/temple-detail.jpg"
                alt="Temple Image"
              />
            </div>
          </div>
